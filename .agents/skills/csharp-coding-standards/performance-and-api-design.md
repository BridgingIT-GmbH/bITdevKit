...
- [Performance and API Design Patterns](#performance-and-api-design-patterns)
  - [Contents](#contents)
  - [Span and Memory for Zero-Allocation Code](#span-and-memory-for-zero-allocation-code)
  - [API Design Principles](#api-design-principles)
    - [Accept Abstractions, Return Appropriately Specific](#accept-abstractions-return-appropriately-specific)
