...
public static class CoreSeedModels
{
                    ...
                    MenuSection.Create($"From the Grill (Main course) {ticks}",
                        ...
                        [
                            ...
                            MenuSectionItem.Create("Grilled Filet Mignon with Béarnaise Sauce",
                                "Duo aliquyam sea aliquyam voluptua elitr eum et duo lorem adipiscing amet. Magna invidunt sanctus ex consectetuer aliquyam. Vero duo sed justo magna magna ex elitr stet lorem ut elitr accusam eirmod diam sed dolore sed magna. Accusam lorem et molestie sanctus sed luptatum et ipsum duis et."),
                            MenuSectionItem.Create("T-Bone Steak with Smoky Barbecue Sauce",
                                "Duo aliquyam sea aliquyam voluptua elitr eum et duo lorem adipiscing amet. Magna invidunt sanctus ex consectetuer aliquyam. Vero duo sed justo magna magna ex elitr stet lorem ut elitr accusam eirmod diam sed dolore sed magna. Accusam lorem et molestie sanctus sed luptatum et ipsum duis et."),
    ...
    public static IEnumerable<Dinner> Dinners(long ticks)
    {
        return new[]
        {
            Dinner.Create($"Garden Delights: A Vegetarian Affair {ticks}",
                "Duo aliquyam sea aliquyam voluptua elitr eum et duo lorem adipiscing amet. Magna invidunt sanctus ex consectetuer aliquyam. Vero duo sed justo magna magna ex elitr stet lorem ut elitr accusam eirmod diam sed dolore sed magna. Accusam lorem et molestie sanctus sed luptatum et ipsum duis et.",
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2023, 8, 26, 18, 30, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2023, 8, 26, 22, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("Art Otel",
            ...
            Dinner.Create($"Seasonal Splendor: A Harvest Feast {ticks}",
                "Duo aliquyam sea aliquyam voluptua elitr eum et duo lorem adipiscing amet. Magna invidunt sanctus ex consectetuer aliquyam. Vero duo sed justo magna magna ex elitr stet lorem ut elitr accusam eirmod diam sed dolore sed magna. Accusam lorem et molestie sanctus sed luptatum et ipsum duis et.",
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2023, 8, 26, 18, 30, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2023, 8, 26, 22, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("Café Restaurant Nieges",
                    "Westerdoksdijk 40H",
                    null,
                    "1013 AE",
                    "Amsterdam",
            ...
            Dinner.Create($"Fire & Spice: A Fiery Fusion of Flavors {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2023, 9, 10, 19, 0, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2023, 9, 10, 22, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("Spice House",
                    "123 Main St",
                    "Suite 100",
                    "90210",
                    "Beverly Hills",
            ...
            Dinner.Create($"Ocean's Bounty: A Seafood Extravaganza {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2023, 10, 5, 19, 30, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2023, 10, 5, 22, 30, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("The Crab Shack",
                    "456 Ocean Blvd",
                    null,
                    "90265",
                    "Malibu",
            ...
            Dinner.Create($"Asian Fusion: An Eclectic East-West Blend {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2023, 12, 3, 20, 0, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2023, 12, 3, 23, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("East Meets West",
                    "456 Broadway",
                    null,
                    "10013",
                    "New York",
            ...
            Dinner.Create($"Steakhouse Classics: A Meat-Lover's Paradise {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2024, 1, 14, 19, 0, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2024, 1, 14, 22, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("The Steakhouse",
                    "789 Main St",
                    null,
                    "90210",
                    "Beverly Hills",
            ...
            Dinner.Create($"Oktoberfest Feast: A Traditional German Dinner {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2024, 9, 21, 18, 0, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2024, 9, 21, 21, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("Hofbräuhaus",
                    "Platzl 9",
                    null,
                    "80331",
                    "Munich",
            ...
            Dinner.Create($"Berlin Street Food: A Culinary Tour of the City {ticks}",
                ...
                DinnerSchedule.Create(new DateTimeOffset(new DateTime(2024, 5, 15, 19, 0, 0, DateTimeKind.Utc)),
                    new DateTimeOffset(new DateTime(2024, 5, 15, 22, 0, 0, DateTimeKind.Utc))),
                DinnerLocation.Create("Street Food Market",
                    "Markthalle Neun",
