...
{
    public static IDomainRule ScheduleShouldBeValid(DateTimeOffset startDateTime, DateTimeOffset endDateTime) => new ScheduleShouldBeValidRule(startDateTime, endDateTime);
}