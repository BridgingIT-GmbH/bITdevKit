...
/// <summary>
/// Queue message sent by the WeatherFiesta hello-world orchestration sample.
/// </summary>
/// <example>
/// <code>
/// var message = new WeatherHelloWorldQueueMessage("Hello WeatherFiesta", "manual", DateTimeOffset.UtcNow, ["Prepared"]);
/// </code>
/// </example>
public sealed class WeatherHelloWorldQueueMessage : QueueMessageBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="WeatherHelloWorldQueueMessage" /> class.
    /// </summary>
    public WeatherHelloWorldQueueMessage()
    {
    }
    ...
    /// <param name="steps">The orchestration steps captured before enqueueing.</param>
    public WeatherHelloWorldQueueMessage(
        string greeting,
        string source,
    ...
    /// <summary>
    /// Gets or sets the orchestration steps captured before enqueueing.
    /// </summary>
