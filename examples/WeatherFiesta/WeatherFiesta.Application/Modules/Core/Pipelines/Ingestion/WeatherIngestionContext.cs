...
public sealed class WeatherIngestionContext(City city) : PipelineContextBase
{
    ...
    /// <summary>Gets or sets the city-local period for the next business day generated report.</summary>
    public WeatherReportPeriod NextBusinessDayReportPeriod { get; set; }
}
