...
public class OpenMeteoWeatherAgent : IWeatherAgent
{
        ...
        List<HourlyForecastData> allHourly)
    {
        var forecast = new ForecastData
        {
            ...
            ApparentTemperatureMaxCelsius = (double)daily.ApparentTemperatureMax,
            ApparentTemperatureMinCelsius = (double)daily.ApparentTemperatureMin,
            WeatherCode = daily.WeatherCode,
            PrecipitationSumMm = (double)daily.PrecipitationSum,
            PrecipitationProbability = daily.PrecipitationProbabilityMax,
            WindSpeedMaxKmh = (double)daily.WindSpeedMax,
            WindGustsMaxKmh = (double)daily.WindGustsMax,
            DominantWindDirectionDegrees = daily.DominantWindDirection,
            SunshineDurationSeconds = daily.SunshineDurationSeconds,
            DaylightDurationSeconds = daily.DaylightDurationSeconds,
