...
/// <summary>
/// Adapter that implements the Application-level <see cref="IWeatherGeocodingClient"/>
/// using the Infrastructure-level <see cref="IOpenMeteoClient"/>.
/// </summary>
public class WeatherGeocodingClientAdapter : IWeatherGeocodingClient
{
    private readonly IOpenMeteoClient openMeteoClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="WeatherGeocodingClientAdapter"/> class.
    /// </summary>
    /// <param name="openMeteoClient">The Open-Meteo client to delegate to.</param>
    public WeatherGeocodingClientAdapter(IOpenMeteoClient openMeteoClient)
    {
