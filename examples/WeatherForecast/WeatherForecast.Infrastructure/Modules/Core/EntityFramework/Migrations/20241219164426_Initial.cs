    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "__Identity_EntityPermissions",
                schema: "core",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK___Identity_EntityPermissions", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX___Identity_EntityPermissions_CreatedDate",
                schema: "core",
                table: "__Identity_EntityPermissions",
                column: "CreatedDate");

            migrationBuilder.CreateIndex(
                name: "IX___Identity_EntityPermissions_EntityId",
                schema: "core",
                table: "__Identity_EntityPermissions",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX___Identity_EntityPermissions_EntityType",
                schema: "core",
                table: "__Identity_EntityPermissions",
                column: "EntityType");

            migrationBuilder.CreateIndex(
                name: "IX___Identity_EntityPermissions_RoleName",
                schema: "core",
                table: "__Identity_EntityPermissions",
                column: "RoleName");

            migrationBuilder.CreateIndex(
                name: "IX___Identity_EntityPermissions_UserId",
                schema: "core",
                table: "__Identity_EntityPermissions",
                column: "UserId");
