...
public interface IEntityPermissionProvider
{
    ...
    Task<bool> HasPermissionAsync(string userId, string[] roles, string entityType, object entityId, string permission);
    ...
    Task<bool> HasPermissionAsync(string userId, string[] roles, string entityType, string permission);
    ...
    Task<IEnumerable<string>> GetEntityIdsWithPermissionAsync(string userId, string[] roles, string entityType, string permission);
    ...
    Task<IEnumerable<object>> GetHierarchyPathAsync(Type entityType, object entityId);
    ...
    Task GrantUserPermissionAsync(string userId, string entityType, object entityId, string permission);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeUserPermissionAsync(string userId, string entityType, object entityId, string permission);
    ...
    /// <param name="userId">The ID of the user.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeUserPermissionsAsync(string userId);
    ...
    /// <param name="permission">The permission to grant.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task GrantRolePermissionAsync(string role, string entityType, object entityId, string permission);
    ...
    /// <param name="permission">The permission to revoke.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeRolePermissionAsync(string role, string entityType, object entityId, string permission);
    ...
    /// <param name="role">The name of the role.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task RevokeRolePermissionsAsync(string role);
    ...
    Task<IReadOnlyCollection<string>> GetUserPermissionsAsync(string userId, string entityType, object entityId);
    ...
    /// <param name="entityId">The ID of the specific entity.</param>
    /// <returns>A read-only collection of permissions.</returns>
    Task<IReadOnlyCollection<string>> GetRolePermissionsAsync(string role, string entityType, object entityId);
}
