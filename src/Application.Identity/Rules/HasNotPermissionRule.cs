    ...
    where TEntity : class, IEntity
{
    ...
    public override string Message
    {
        get
        {
            if (this.entity != null)
            {
                return $"Unauthorized: User must not have {this.permission} permission for entity {typeof(TEntity).Name} with id {this.entity.Id}";
            }
            else if (this.entityId != null)
            {
                return $"Unauthorized: User must not have {this.permission} permission for entity {typeof(TEntity).Name} with id {this.entityId}";
            }

            return $"Unauthorized: User must not have {this.permission} permission for entity {typeof(TEntity).Name}";
        }
    }
