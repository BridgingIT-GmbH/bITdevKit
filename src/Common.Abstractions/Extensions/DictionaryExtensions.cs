...
/// <summary>
/// Provides null-tolerant dictionary lookup and conditional mutation helpers.
/// </summary>
public static class DictionaryExtensions
{
    ...
    /// <summary>
    /// Determines whether a string-keyed dictionary contains a key using ordinal case-insensitive comparison.
    /// </summary>
    /// <typeparam name="TValue">The dictionary value type.</typeparam>
    /// <param name="source">The dictionary to inspect.</param>
    /// <param name="key">The key to locate.</param>
    /// <returns><see langword="true"/> when an equal key exists; otherwise, <see langword="false"/>, including for a null dictionary.</returns>
