...
public static class AsyncEnumerableExtensions
{
    ...
    public static async IAsyncEnumerable<T> ConcatAsync<T>(this IAsyncEnumerable<T> source, IAsyncEnumerable<T> second, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        await foreach (var item in source.WithCancellation(cancellationToken).ConfigureAwait(false))
        {
            yield return item;
    ...
    public static ValueTask<bool> ContainsAsync<T>(this IAsyncEnumerable<T> source, T value, CancellationToken cancellationToken = default)
    {
        return ContainsAsync(source, value, comparer: null, cancellationToken);
    }
    ...
    public static IAsyncEnumerable<T> DistinctAsync<T>(this IAsyncEnumerable<T> source, CancellationToken cancellationToken = default)
    {
        return DistinctAsync(source, comparer: null, cancellationToken);
    }

    public static async IAsyncEnumerable<T> DistinctAsync<T>(this IAsyncEnumerable<T> source, IEqualityComparer<T> comparer, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
    ...
    public static IAsyncEnumerable<T> DistinctByAsync<T, TKey>(this IAsyncEnumerable<T> source, Func<T, TKey> getKey, CancellationToken cancellationToken = default)
    {
        return DistinctByAsync(source, getKey, comparer: null, cancellationToken);
    }
    ...
    public static ValueTask<T> LastAsync<T>(this IAsyncEnumerable<T> source, CancellationToken cancellationToken = default)
    {
    ...
    public static ValueTask<T> LastOrDefaultAsync<T>(this IAsyncEnumerable<T> source, CancellationToken cancellationToken = default)
    {
    ...
    public static async IAsyncEnumerable<T> WhereAsync<T>(this IAsyncEnumerable<T> source, Func<T, bool> selector, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        await foreach (var item in source.WithCancellation(cancellationToken).ConfigureAwait(false))
        {
            if (selector(item))
    ...
    public static IAsyncEnumerable<T> WhereNotNull<T>(this IAsyncEnumerable<T> source, CancellationToken cancellationToken = default)
        where T : class
    {
