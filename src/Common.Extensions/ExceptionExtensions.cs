...
public static class ExceptionExtensions
{
    ...
    public static bool IsExpectedException<TEx>(this Exception ex)
        where TEx : Exception
    {
        return ex.IsExpectedException(e => e is TEx);
    }
    ...
    {
        return ex.IsExpectedException(e => e is TEx1 || e is TEx2);
    }
    ...
    {
        return ex.IsExpectedException(e => e is TEx1 || e is TEx2 || e is TEx3);
    }
    ...
    {
        return ex.IsExpectedException(e => e is TEx1 || e is TEx2 || e is TEx3 || e is TEx4);
    }
    ...
    {
        return ex.IsExpectedException(e => e is TEx1 || e is TEx2 || e is TEx3 || e is TEx4 || e is TEx5);
    }
    ...
    {
        return ex.IsExpectedException(e => e is TEx1 || e is TEx2 || e is TEx3 || e is TEx4 || e is TEx5 || e is TEx6);
    }
    ...
    {
        return ex.IsExpectedException(e =>
