...
public static class ResultCollectionExtensions
{
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<T>> Filter<T>(
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> FilterAsync<T>(
        this Result<IEnumerable<T>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> Filter<T>(
        ...
        ProcessingOptions options = null)
    {
        ...
        try
        {
            ...
            return result.Filter(predicate, options);
        }
        catch (Exception ex)
        {
            return Result<IEnumerable<T>>.Failure()
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return await result.FilterAsync(predicate, options, cancellationToken);
        }
        catch (OperationCanceledException)
        {
            return Result<IEnumerable<T>>.Failure()
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<TResult>> Map<TSource, TResult>(
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<TResult>>> MapAsync<TSource, TResult>(
        this Result<IEnumerable<TSource>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<TResult>>> Map<TSource, TResult>(
        ...
        ProcessingOptions options = null)
    {
        ...
        try
        {
            ...
            return result.Map(mapper, options);
        }
        catch (Exception ex)
        {
            return Result<IEnumerable<TResult>>.Failure()
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return await result.MapAsync(mapper, options, cancellationToken);
        }
        catch (OperationCanceledException)
        {
            return Result<IEnumerable<TResult>>.Failure()
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<TResult>> Bind<TSource, TResult>(
        this Result<IEnumerable<TSource>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<TResult>>> BindAsync<TSource, TResult>(
        this Result<IEnumerable<TSource>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<TResult>>> Bind<TSource, TResult>(
        this Task<Result<IEnumerable<TSource>>> resultTask,
        Func<TSource, Result<IEnumerable<TResult>>> binder,
        ProcessingOptions options = null)
    {
        ...
        try
        {
            ...
            return result.Bind(binder, options);
        }
        catch (Exception ex)
        {
            return Result<IEnumerable<TResult>>.Failure()
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return await result.BindAsync(binder, options, cancellationToken);
        }
        catch (OperationCanceledException)
        {
            return Result<IEnumerable<TResult>>.Failure()
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<T>> Tap<T>(
        this Result<IEnumerable<T>> result,
        Action<T> action)
    {
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> TapAsync<T>(
        this Result<IEnumerable<T>> result,
        Func<T, CancellationToken, Task> action,
        CancellationToken cancellationToken = default)
    {
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> Tap<T>(
        this Task<Result<IEnumerable<T>>> resultTask,
        Action<T> action)
    {
        try
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<T>> Do<T>(
        this Result<IEnumerable<T>> result,
        Action action)
    {
        if (action is null)
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> DoAsync<T>(
        this Result<IEnumerable<T>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> Do<T>(
        this Task<Result<IEnumerable<T>>> resultTask,
        Action action)
    {
        try
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<TResult>> TeeMap<TSource, TResult>(
        this Result<IEnumerable<TSource>> result,
        Func<TSource, TResult> mapper,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<TResult>>> TeeMapAsync<TSource, TResult>(
        this Result<IEnumerable<TSource>> result,
        Func<TSource, TResult> mapper,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> ValidateAsync<T>(
        this Result<IEnumerable<T>> result,
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<T>> ValidateWhere<T>(
        this Result<IEnumerable<T>> result,
        Func<T, bool> predicate,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> ValidateWhereAsync<T>(
        this Result<IEnumerable<T>> result,
        Func<T, CancellationToken, Task<bool>> predicate,
        Func<T, IResultError> errorFactory = null,
        ProcessingOptions options = null,
    ...
    /// </code>
    /// </example>
    public static Result<IEnumerable<T>> ValidateAll<T>(
        this Result<IEnumerable<T>> result,
    ...
    /// </code>
    /// </example>
    public static async Task<Result<IEnumerable<T>>> ValidateAllAsync<T>(
        this Result<IEnumerable<T>> result,
        IValidator<T> validator,
        ProcessingOptions options = null,
        CancellationToken cancellationToken = default)
