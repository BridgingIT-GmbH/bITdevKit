...
/// <summary>
/// A factory class for creating JSON converters for ResultPaged{T} objects.
/// </summary>
public sealed class ResultPagedJsonConverterFactory : JsonConverterFactory
{
    /// <summary>
    ...
    public override bool CanConvert(Type typeToConvert)
    {
        ...
        return typeToConvert.GetGenericTypeDefinition() == typeof(ResultPaged<>);
    }
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        var converterType = typeof(ResultPagedJsonConverter<>).MakeGenericType(valueType);
