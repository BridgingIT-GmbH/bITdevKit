...
public static class Retry
{
    ...
    public static Task On<TEx>(Func<Task> func, ILogger logger = null, params TimeSpan[] delays)
        where TEx : Exception
    {
        return On(func, e => e.IsExpectedException<TEx>(), logger, delays);
    }
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2>(), logger, delays);
    }
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2, TEx3>(), logger, delays);
    }

    /// <summary>
    ///     Retries the given <paramref name="func" /> in case of any of the given exceptions specified by
    ///     <typeparamref name="TEx1" />, <typeparamref name="TEx2" />, <typeparamref name="TEx3" /> and
    ///     <typeparamref name="TEx4" />.
    ///     <remarks>
    ///         If the given <paramref name="delays" /> is not supplied then the given
    ///         <paramref name="func" /> will be retried once.
    ///     </remarks>
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2, TEx3, TEx4>(), logger, delays);
    }
    ...
    /// </summary>
    [DebuggerStepThrough]
    public static Task OnAny<TEx1, TEx2, TEx3, TEx4, TEx5>(
        Func<Task> func,
        ILogger logger = null,
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2, TEx3, TEx4, TEx5>(), logger, delays);
    }
    ...
    /// </summary>
    [DebuggerStepThrough]
    public static Task OnAny<TEx1, TEx2, TEx3, TEx4, TEx5, TEx6>(
        Func<Task> func,
        ILogger logger = null,
        params TimeSpan[] delays)
        where TEx1 : Exception
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2, TEx3, TEx4, TEx5, TEx6>(), logger, delays);
    }
    ...
    /// </summary>
    [DebuggerStepThrough]
    public static Task OnAny<TEx1, TEx2, TEx3, TEx4, TEx5, TEx6, TEx7>(
        Func<Task> func,
        ILogger logger = null,
        params TimeSpan[] delays)
        where TEx1 : Exception
    ...
    {
        return On(func, e => e.IsExpectedException<TEx1, TEx2, TEx3, TEx4, TEx5, TEx6, TEx7>(), logger, delays);
    }
    ...
    /// </summary>
    [DebuggerStepThrough]
    public static Task<TResult> On<TEx, TResult>(
