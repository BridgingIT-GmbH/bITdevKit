...
/// <summary>
/// Represents the entity updated domain event domain event.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <c>EntityUpdatedDomainEvent</c> class.
    /// </summary>
    protected EntityUpdatedDomainEvent() : this(default)
    { }
