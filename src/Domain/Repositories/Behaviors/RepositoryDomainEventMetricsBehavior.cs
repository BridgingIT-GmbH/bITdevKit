    ...
    where TEntity : class, IEntity, IAggregateRoot
{
    ...
    /// <summary>
    /// Initializes a new instance of the <c>RepositoryDomainEventMetricsBehavior</c> class.
    /// </summary>
    /// <param name="inner">The inner used by the operation.</param>
    /// <param name="metricsService">The metrics service used by the operation.</param>
