namespace BridgingIT.DevKit.Infrastructure.Azure.ServiceBus;

using BridgingIT.DevKit.Application.Queueing;
using BridgingIT.DevKit.Common;

/// <summary>
/// Provides operational access to the Azure Service Bus queue broker runtime state.
/// </summary>
public class ServiceBusQueueBrokerService(
    ServiceBusQueueBrokerRuntime runtime,
    ServiceBusQueueBrokerOptions options,
