...
/// <summary>
/// Configuration values for binding the Azure Queue Storage message broker from <see cref="Microsoft.Extensions.Configuration.IConfiguration" />.
/// </summary>
public class AzureQueueStorageMessageBrokerConfiguration
{
    /// <summary>
