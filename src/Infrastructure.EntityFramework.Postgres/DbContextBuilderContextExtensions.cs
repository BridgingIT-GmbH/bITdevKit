...
/// <summary>
/// Provides PostgreSQL specific health check extensions for EF Core DbContext registrations.
/// </summary>
public static class DbContextBuilderContextExtensions
{
    /// <summary>
    /// Registers the standard EF Core DbContext health probe for the configured PostgreSQL context.
    /// </summary>
    ...
    /// <example>
    /// <code>
    /// services.AddPostgresDbContext&lt;CoreDbContext&gt;(o => o.UseConnectionString(connectionString))
    ///     .WithHealthCheck();
    /// </code>
    /// </example>
    public static PostgresDbContextBuilderContext<TContext> WithHealthCheck<TContext>(
        ...
        where TContext : DbContext
    {
        context.Services.AddHealthChecks()
            .AddDbContextCheck<TContext>(
                ...
                failureStatus,
                tags ?? ["db", "dbcontext", "entityframework", "postgres"]);
