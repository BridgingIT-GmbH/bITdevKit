...
/// </remarks>
public class PostgresModuleDbContextFactory<TContext> : IDesignTimeDbContextFactory<TContext>
    where TContext : DbContext
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostgresModuleDbContextFactory{TContext}"/> class with a convention-based connection string key.
    /// </summary>
    ...
    public PostgresModuleDbContextFactory(
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostgresModuleDbContextFactory{TContext}"/> class with a specified connection string key.
    /// </summary>
    ...
    public TContext CreateDbContext(string[] args)
    {
        ...
        if (optionsBuilder.Options.Extensions.Any(e => e.GetType().Name.Contains("Npgsql", StringComparison.OrdinalIgnoreCase)))
        {
            optionsBuilder.ReplaceService<IMigrationsSqlGenerator,
                PostgresIdempotentMigrationsSqlGenerator>();
        }
