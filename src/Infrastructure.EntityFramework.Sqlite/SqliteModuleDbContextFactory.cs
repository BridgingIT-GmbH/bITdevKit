...
/// </remarks>
public class SqliteModuleDbContextFactory<TContext> : IDesignTimeDbContextFactory<TContext>
    where TContext : DbContext
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SqliteModuleDbContextFactory{TContext}"/> class with a convention-based connection string key.
    /// </summary>
    ...
    public SqliteModuleDbContextFactory(
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SqliteModuleDbContextFactory{TContext}"/> class with a specified connection string key.
    /// </summary>
    ...
    public TContext CreateDbContext(string[] args)
    {
        ...
        if (optionsBuilder.Options.Extensions.Any(e => e.GetType().Name.Contains("Sqlite", StringComparison.OrdinalIgnoreCase)))
        {
            optionsBuilder.ReplaceService<IMigrationsSqlGenerator,
                SqliteIdempotentMigrationsSqlGenerator>();
        }
