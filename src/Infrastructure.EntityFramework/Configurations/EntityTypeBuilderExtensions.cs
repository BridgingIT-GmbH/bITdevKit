...
public static class EntityTypeBuilderExtensions
{
        ...
        where TEntity : class, IEntity, IAuditable
    {
        ...
        builder.OwnsOne(e => e.AuditState,
            o =>
            {
                o.Property(e => e.CreatedBy).HasMaxLength(256);

                o.Property(e => e.CreatedDate);

                o.Property(e => e.CreatedDescription).HasMaxLength(1024);

                o.Property(e => e.UpdatedBy).HasMaxLength(256);

                o.Property(e => e.UpdatedDate);

                o.Property(e => e.UpdatedDescription).HasMaxLength(1024);

                o.Property(e => e.UpdatedReasons)
                    .HasConversion<
                        StringsArraySemicolonConverter>() // TODO: .NET8 use new ef core primitive collections here (store as json) https://learn.microsoft.com/en-us/ef/core/what-is-new/ef-core-8.0/whatsnew#primitive-collections
                    .HasMaxLength(8192)
                    .Metadata.SetValueComparer(valueComparer);

                o.Property(e => e.DeactivatedBy).HasMaxLength(256);

                o.Property(e => e.DeactivatedDate);

                o.Property(e => e.DeactivatedDescription).HasMaxLength(1024);
                ...
                o.Property(e => e.DeletedBy).HasMaxLength(256);

                o.Property(e => e.DeletedDate);

                o.Property(e => e.DeletedReason).HasMaxLength(1024);

                o.Property(e => e.DeletedDescription).HasMaxLength(1024);
            });
