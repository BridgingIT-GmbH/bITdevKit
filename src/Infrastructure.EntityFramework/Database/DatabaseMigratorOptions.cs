...
/// <summary>
/// Configures database migrator.
/// </summary>
public class DatabaseMigratorOptions : OptionsBase
{
    /// <summary>
    ///     Gets or sets a value indicating whether the application process should be terminated immediately when migration fails.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the database migrator is enabled.
    /// </summary>
    public bool Enabled { get; set; } = true;

    /// <summary>
    ///     Gets or sets the delay before the database migrator starts.
    /// </summary>
