...
///// </remarks>
//public class ModuleDbContextFactory<TContext> : IDesignTimeDbContextFactory<TContext>
...
//    /// <summary>
//    /// Initializes a new instance of the <see cref="ModuleDbContextFactory{TContext}"/> class with a convention-based connection string key.
//    /// </summary>
...
//    /// <summary>
//    /// Initializes a new instance of the <see cref="ModuleDbContextFactory{TContext}"/> class with a specified connection string key.
//    /// </summary>
...
//        //        IdempotentSqlServerMigrationsSqlGenerator>();
//        //}
//        //else if (optionsBuilder.Options.Extensions.Any(e => e.GetType().Name.Contains("Npgsql", StringComparison.OrdinalIgnoreCase)))
//        //{
//        //    optionsBuilder.ReplaceService<IMigrationsSqlGenerator,
//        //        IdempotentPostgresMigrationsSqlGenerator>();
//        //}
//        //else if (optionsBuilder.Options.Extensions.Any(e => e.GetType().Name.Contains("Sqlite", StringComparison.OrdinalIgnoreCase)))
//        //{
//        //    optionsBuilder.ReplaceService<IMigrationsSqlGenerator,
//        //        IdempotentSqliteMigrationsSqlGenerator>();
//        //}
