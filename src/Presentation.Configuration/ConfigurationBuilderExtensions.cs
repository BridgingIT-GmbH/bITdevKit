...
public static class ConfigurationBuilderExtensions
{
        ...
        string environment = null)
    {
        ...
        if (!environment.IsNullOrEmpty())
        {
            ...
            {
                if (file.EndsWith($".appsettings.{environment}.json",
        ...
        {
            return Directory.EnumerateFiles(Directory.GetParent(AppContext.BaseDirectory).FullName, pattern);
        }
    }
        ...
        string environment = null)
    {
        ...
        if (!string.IsNullOrEmpty(azureAppConfigConnectionString) &&
            !tmpCfg["AzureAppConfig:Enabled"].SafeEquals("False"))
        {
