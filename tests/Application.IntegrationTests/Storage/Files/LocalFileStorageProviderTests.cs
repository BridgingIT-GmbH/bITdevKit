...
public class LocalFileStorageProviderTests(ITestOutputHelper output, TestEnvironmentFixture fixture) : FileStorageTestsBase
{
    ...
    protected override IFileStorageProvider CreateProvider()
    {
        ...
        return new LoggingFileStorageBehavior(
            new LocalFileStorageProvider("TestLocal", tempPath),
    ...
    public async Task CheckHealthAsync_HealthyStorage_ReturnsSuccess()
    {
        ...
        result.ShouldContainMessage($"Local storage at '{provider.LocationName}' is healthy");
    }
