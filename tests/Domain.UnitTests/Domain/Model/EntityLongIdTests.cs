...
public class EntityLongIdTests
{
    ...
    {
        var entity = new StubEntity { Id = 1L };
    ...
    {
        var entity1 = new StubEntity { Id = 1L };
        var entity2 = new StubEntity { Id = 2L };
    ...
    {
        var entity1 = new StubEntity();
        var entity2 = new StubEntity { Id = 1L };
        Assert.False(entity1.Equals(entity2));
    }
    ...
    {
        var entity = new StubEntity { Id = 0L };
        Assert.False(entity.Equals(new StubEntity { Id = 0L })); // because id is default (entity is transient)
    }
    ...
    {
        var entity = new StubEntity { Id = 1L };
        Assert.False(entity.Equals(new StubEntity { Id = 2L }));
    }
