...
public class EnabledPolicy : DomainPolicyBase<StubContext>
{
    ...
    {
        return Task.FromResult<Result>(DomainPolicyResult<int>.Success(1)
            .WithMessage("Always satisfied policy applied"));
    }
}
...
public class DisabledPolicy : DomainPolicyBase<StubContext>
{
    ...
    public override Task<Result> ApplyAsync(StubContext context, CancellationToken cancellationToken = default)
    {
        return Task.FromResult<Result>(DomainPolicyResult<int>.Success(2)
            .WithMessage("This should never be called"));
    }
}
...
public class ConditionalEnabledPolicy : DomainPolicyBase<StubContext>
{
    ...
    public override Task<Result> ApplyAsync(StubContext context, CancellationToken cancellationToken = default)
    {
        return Task.FromResult<Result>(DomainPolicyResult<int>.Success(3)
...
public class FailingPolicy : DomainPolicyBase<StubContext>
{
    public override Task<Result> ApplyAsync(StubContext context, CancellationToken cancellationToken = default)
    {
        return Task.FromResult<Result>(DomainPolicyResult<int>.Failure()
