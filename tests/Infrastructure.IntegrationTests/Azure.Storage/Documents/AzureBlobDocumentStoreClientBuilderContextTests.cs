...
public class AzureBlobDocumentStoreClientBuilderContextTests : IDisposable
{
    private readonly TestEnvironmentFixture fixture;
    private readonly ITestOutputHelper output;
    private readonly ServiceProvider serviceProvider;

    public AzureBlobDocumentStoreClientBuilderContextTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
        ...
        services.AddAzureBlobServiceClient(o => o
                .UseConnectionString(this.fixture.AzuriteConnectionString));

        services.AddAzureBlobDocumentStoreClient<PersonStubDocument>() // no need to setup the client+provider (sql)
    ...
    //    // Arrange
    //    // Act
    //    var sut = this.fixture.ServiceProvider.GetService<BlobServiceClient>();
