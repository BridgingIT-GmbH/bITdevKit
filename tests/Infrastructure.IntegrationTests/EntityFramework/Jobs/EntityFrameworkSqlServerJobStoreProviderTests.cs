...
public class EntityFrameworkSqlServerJobStoreProviderTests(ITestOutputHelper output, JobsTestEnvironmentFixture fixture) : EntityFrameworkJobStoreProviderTestsBase, IDisposable
{
