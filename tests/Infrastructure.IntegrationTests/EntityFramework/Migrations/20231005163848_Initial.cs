        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonStubId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Locations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Locations_Persons_PersonStubId",
                        column: x => x.PersonStubId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_PersonStubId",
                table: "Locations",
                column: "PersonStubId");
        }
