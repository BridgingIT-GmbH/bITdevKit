...
public class EntityFrameworkSqlServerOrchestrationStorageTests : EntityFrameworkOrchestrationStorageTestsBase, IDisposable
{
    private readonly EntityFrameworkOrchestrationTestSupport support;

    public EntityFrameworkSqlServerOrchestrationStorageTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
