...
public class EntityFrameworkSqliteGenericRepositoryTests : EntityFrameworkGenericRepositoryTestsBase
{
    private readonly TestEnvironmentFixture fixture;
    private readonly ITestOutputHelper output;

    public EntityFrameworkSqliteGenericRepositoryTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
