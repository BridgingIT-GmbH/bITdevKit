...
public class EntityFrameworkSqlServerGenericRepositoryResultTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    : EntityFrameworkGenericRepositoryResultTestsBase
{
    private readonly TestEnvironmentFixture fixture = fixture.WithOutput(output);
    private readonly ITestOutputHelper output = output;
    private readonly string connectionString = fixture.CreateSqlConnectionString($"Repositories_Result_{Guid.NewGuid():N}");
    ...
    [Fact]
    public override async Task FindAllResultAsync_AnyEntity_EntitiesFound()
    {
        await base.FindAllResultAsync_AnyEntity_EntitiesFound();
    }
