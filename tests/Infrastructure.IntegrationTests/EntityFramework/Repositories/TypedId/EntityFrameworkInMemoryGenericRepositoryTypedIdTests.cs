...
public class EntityFrameworkInMemoryGenericRepositoryTypedIdTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    : EntityFrameworkGenericRepositoryTypedIdTestsBase
{
    ...
    [Fact]
    public override async Task FindAllAsync_ChildEntitySpecification_EntitiesFound()
    {
        await base.FindAllAsync_ChildEntitySpecification_EntitiesFound();
    }
