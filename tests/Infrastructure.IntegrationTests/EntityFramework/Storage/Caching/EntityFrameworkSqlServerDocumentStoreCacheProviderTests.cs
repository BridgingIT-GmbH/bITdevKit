...
public class EntityFrameworkSqlServerDocumentStoreCacheProviderTests : EntityFrameworkDocumentStoreCacheProviderTestsBase
{
    private readonly TestEnvironmentFixture fixture;
    private readonly ITestOutputHelper output;

    public EntityFrameworkSqlServerDocumentStoreCacheProviderTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
