...
public class EntityFrameworkSqlServerDocumentStoreProviderTests : EntityFrameworkDocumentStoreProviderTestsBase
{
    private readonly TestEnvironmentFixture fixture;
    private readonly ITestOutputHelper output;

    public EntityFrameworkSqlServerDocumentStoreProviderTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
