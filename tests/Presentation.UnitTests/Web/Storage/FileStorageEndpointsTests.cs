...
public class FileStorageEndpointsTests : IAsyncDisposable
{
    ...
    {
        var response = await this.client.GetAsync("/_bdk/api/storage/files/documents/provider");
        var hiddenResponse = await this.client.GetAsync("/_bdk/api/storage/files/hidden/provider");
    ...
    {
        var response = await this.client.GetAsync("/_bdk/api/storage/files/locations");
    ...
    {
        var response = await this.client.GetAsync("/_bdk/api/storage/files/missing/provider");
    ...
    public async Task PutAndGetFileContent_ShouldRoundTripBytes()
    {
        var putResponse = await this.client.PutAsync(
            "/_bdk/api/storage/files/documents/files/content?path=docs/guide.txt",
            new ByteArrayContent(Encoding.UTF8.GetBytes("Hello from endpoint storage")));

        var getResponse = await this.client.GetAsync("/_bdk/api/storage/files/documents/files/content?path=docs/guide.txt");
    ...
    public async Task GetFileMetadata_ShouldReturnStoredMetadata()
    {
        ...
        var response = await this.client.GetAsync("/_bdk/api/storage/files/documents/files/metadata?path=meta/file.txt");
    ...
    public async Task ListFiles_ShouldReturnStoredFiles()
    {
        ...
        var response = await this.client.GetAsync("/_bdk/api/storage/files/documents/files?path=docs&searchPattern=*.txt&recursive=true");
    ...
    {
        var createResponse = await this.client.PostAsync("/_bdk/api/storage/files/documents/directories?path=ops/archive", null);
        var existsAfterCreateResponse = await this.client.GetAsync("/_bdk/api/storage/files/documents/directories/exists?path=ops/archive");
        var existsAfterCreate = await existsAfterCreateResponse.Content.ReadFromJsonAsync<FileStorageExistsResponseModel>();

        var deleteResponse = await this.client.DeleteAsync("/_bdk/api/storage/files/documents/directories?path=ops/archive&recursive=true");
        var existsAfterDeleteResponse = await this.client.GetAsync("/_bdk/api/storage/files/documents/directories/exists?path=ops/archive");
    ...
    {
        var response = await this.client.GetAsync("/_bdk/api/storage/files/documents/files/content?path=missing/file.txt");
    ...
    public async Task GetFileEvents_ShouldReturnStoredEvents()
    {
        ...
        var response = await this.client.GetAsync("/_bdk/api/storage/files/documents/events?path=docs/guide.txt&eventType=Changed");
    ...
    public async Task ScanFileEvents_ShouldDetectProviderChanges()
    {
        ...
        var response = await this.client.PostAsync("/_bdk/api/storage/files/documents/events/scan?waitForProcessing=true", null);
        response.StatusCode.ShouldBe(HttpStatusCode.OK);
    ...
    {
        var response = await this.client.PostAsync("/_bdk/api/storage/files/hidden/events/scan?waitForProcessing=true", null);
